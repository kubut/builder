...
class InstancesChannel implements MessageComponentInterface
{
    /** @var InstancesActionHandlerFactory */
     ...
     * @param InstancesActionHandlerFactory $actionHandler
     * @param ParamsValidator $paramsValidator
     * @param WebSocketAuthentication $authenticationModel
     */
    public function __construct(
        InstancesActionHandlerFactory $actionHandler,
